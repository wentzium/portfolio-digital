<template>
	<div class="h100pct">
		<div class="head " style="margin-bottom: 10px;">
    		<Row>
    			<Col span="24" class="ta-r">
    				<Button disabled="disabled" type="primary" icon="ios-paper-plane-outline" @click="sentApply"> 发送申请单</Button>
    			</Col>
    		</Row>
    	</div>
		            	...
		            	<section class="h100pct sys-mian-panel">
		            		...
		            		<div class="content">
		            			<Row :gutter="10" style="padding: 5px 0;">
		            				<Col span="12">
		            					ID:
		            					<Input v-model="patientNo" size="small" :disabled="inputDisabled"></Input>
		            				</Col>
		            				<!--<Col span="12">病理号：
			                ...
			                <TabPane class="h100pct fs12x" label="临床">
			                	...
			                	<Row class="h50pct" :gutter="10" >
		            				<Col class="h100pct" span="12">
		            					<label>影像检查结果</label>
		            					<div class="main-lc">
		            						<textarea v-model="patientInfo.imageInspect" :disabled="inputDisabled"
		            						class="w100pct h100pct"
		            						 placeholder="影像检查结果" />
		            					</div>
		            				</Col>
		            			...
		            			<!--<Row class="h100pct" :gutter="10" >
		            				<div>
	            						<label>手术名称</label>
	            						<Select :transfer="Boolean(true)" disabled="disabled" v-model="patientInfo.operationId" filterable>
		            			...
		            			<Row class="h100pct" :gutter="10" >
		            				<Col class="h100pct" span="12">
		            					...
		            					<div style="line-height: 32px;">
		            						<RadioGroup  v-model="patientInfo.hasPathologyCheck">
										        <Radio :disabled="inputDisabled" :label="Number(1)">是</Radio>
										        <Radio :disabled="inputDisabled" :label="Number(0)">否</Radio>
										    </RadioGroup>
		            					</div>
		            					<div class="h80pct pt10x">
		            						<label>临床检查</label>
		            				...
		            				<Col class="h100pct" span="12">
		            					<div>
		            						<label>手术名称</label>
		            						<Select :disabled="inputDisabled"  :transfer="Boolean(true)" v-model="patientInfo.operationId" filterable>
								                <Option value="new" style="border-top: 1px solid #C3C3C3;">其他</Option>
								            </Select>
		            					</div>
		            					<div class="h80pct pt10x">
		            	...
		            	<div class="title">
	            			<Row type="flex" justify="center" align="middle">
	            				...
	            				<Col class="fs14x ta-r" span="12">
	            					<Button disabled="disabled" type="primary" icon="ios-print-outline" @click="printTag" class="ml10x" :loading="printTagFlag">打印</Button>
	            					<Button disabled="disabled" type="primary" icon="ios-remove-circle-outline" @click="sampleDeleteShow" class="ml10x">作废</Button>
	            				</Col>
	            			</Row>
	            		</div>
	            		<div class="content">
			            			...
			            			<Row :gutter="10" type="flex">
			            				<Col span="6" v-for="sample in sampleList">
			            					<div class="sample w100pct posR" style="border: 1px solid #CBCBCB;border-radius: 2px;margin-bottom: 10px;">
			            						<div class="w100pct posR" :class="[sample.fixedStatus==0?'bg-status-unfixed':'bg-status-fixed']" style="padding-bottom: 75%;">
			            							<div class="sample-head">
			            								<span class="dpIB ta-c" style="line-height: 20px;color: #fff;">{{sample.sampleNo}}</span>
...
export default {
  name: 'ApplyInfo',
  components: {GlobalLayout,vuescroll,AddSample,SampleDetail,Printing,SampleDelete,PrintTag},
  props:{
