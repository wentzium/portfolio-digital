	...
	<Modal
        ...
        <template slot="header">
	        ...
	        <p style="margin-bottom: 16px;">
	        	<span class="tag"><label class="tag-text" @click="reqVo.reason='理由理由理由理由理由理由'">理由理由理由理由理由理由</label></span>
	        	<span class="tag"><label class="tag-text" @click="reqVo.reason='理由理由理由理由理由理由1'">理由理由理由理由理由理由1</label></span>
	        	<span class="tag"><label class="tag-text" @click="reqVo.reason='理由理由理由理由理由理由2'">理由理由理由理由理由理由2</label></span>
	        </p>
