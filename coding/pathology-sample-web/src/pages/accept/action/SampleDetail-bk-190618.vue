    		...
    		<div class="content">
    			<Row class="pt10x">
					<Col span="24">
						<Form :label-width="80">
							<FormItem label="样本编号:">
					            <Input v-model="sampleNo" ><Button @click="acceptSample" slot="append">读取</Button></Input>
					        </FormItem>
						</Form>
					</Col>
				</Row>
        	...
        	<div class="h100pct sys-mian-panel">
				...
				<div class="pt16x">
					...
					<Row :gutter="5" v-if="sampleInfo.sampleNo">
						...
						<Col span="8"><Button class="mr10x w100pct" type="primary" @click="reject=true">拒收</Button></Col>
					</Row>
				</div>
