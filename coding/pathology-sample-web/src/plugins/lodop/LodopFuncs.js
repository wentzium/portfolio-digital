...
export function getLodop(oOBJECT,oEMBED){
    ...
    try{
		...
		LODOP.SET_LICENSES("徕卡显微系统（上海）有限公司","5D9164BE5FA896FCD8E8061596E04FA2F01","徠卡顯微系統（上海）有限公司","494E31FA96E65C36765161A245C96AA0C01");
		LODOP.SET_LICENSES("THIRD LICENSE","","Leica Microsystems Ltd. Shanghai","8B40A522516DAA8F323574C7A2C34EB50CC");
        //===========================================================
        return LODOP;
