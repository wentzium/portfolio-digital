...
import com.mxs.thirdpartyservice.hystrix.SpringCloudHystrixConcurrencyStrategy;
...
public class CommonConfiguration extends WebMvcConfigurerAdapter{
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new UserContextInterceptor()).excludePathPatterns("/user/login","/user/register");
    }
